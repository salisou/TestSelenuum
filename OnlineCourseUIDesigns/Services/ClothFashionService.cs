...
namespace OnlineCourseUIDesigns.Services
{
    public class ClothFashionService
    {
        public IEnumerable<Item> GetPromoItems()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                results.Add(new Item { Id = 1, Image = "pantspio.jpg" });
                results.Add(new Item { Id = 2, Image = "coatgeremia.jpg" });
                results.Add(new Item { Id = 3, Image = "blazergloria.jpg" });
                results.Add(new Item { Id = 4, Image = "trouserskous.jpg" });
                results.Add(new Item { Id = 5, Image = "woolstriped.jpg" });
                results.Add(new Item { Id = 6, Image = "shirtfurio.jpg" });
                results.Add(new Item { Id = 7, Image = "sweatermarcello.jpg" }); ;
                results.Add(new Item { Id = 8, Image = "shirtcroccante.jpg" });
            }
            return results;
        }
